...
#graybarcontainer {height:126px; width:900px;	background-image:url(colors/<?php include 'custom/text_files/10.txt'; ?>/graybar_point.jpg); background-repeat: no-repeat; background-position: 50% 50%; background-position: 91% 0%; margin:0 auto;}
</style>
...
<?php include 'includes/article5.txt'; ?>
